...
public class StrongholdAuton {
	...
	private static int	AFTER_DEFENSE_FEET = 5,
						MOVE_DISTANCE_POST_DEFENSE_P1_FEET = 9 - AFTER_DEFENSE_FEET, // ok
						MOVE_DISTANCE_POST_DEFENSE_P2_FEET_LEFT_PATH = 11  - AFTER_DEFENSE_FEET, // ok
						MOVE_DISTANCE_POST_DEFENSE_P2_FEET_CENTER_PATH = 5  - AFTER_DEFENSE_FEET, // ok
						...
						MOVE_DISTANCE_POST_DEFENSE_P5_FEET_RIGHT_PATH = 13  - AFTER_DEFENSE_FEET, // ok
						MOVE_DISTANCE_POST_DEFENSE_SIDEWAY_P5_FEET_SECRET_PATH = 5,
						MOVE_DISTANCE_POST_DEFENSE_P5_FEET_SECRET_PATH = 8 - AFTER_DEFENSE_FEET;
